...
class Instructor extends Lambdasian {
  ...
  grading(student, num1, num2) {
    var plusOrMinus = Math.random() < 0.5 ? -1 : 1;
    let number = Math.random() * (num1 - num2) - num2;
    let answer = number * plusOrMinus;
    student.grade = student.grade + answer;
  }
}
...
class ProjectManager extends Instructor {
  constructor(projManObj) {
    super(projManObj);
    this.gradClassName = projManObj.gradClassName;
    this.favInstructor = projManObj.favInstructor;
  }
  standUp(channel) {
